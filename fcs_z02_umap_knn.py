"""
At this step z02, 
edgelist of 15-NN graph will be calculated.
umap projection coordinates will be calculated.
They will run in parallelly to save time. umap calculate takes longer.
"""
...
if __name__ == "__main__":
    ...
    with open('config.yaml', 'r') as f:
        ...
        figure_dir = config['z02']['figure_dir'] # figure_dir: where to save figures
        fcsdata_BCed = config['z02']['fcsdata']       # data location
        cofactorfile = config['z02']['cofactorfile']
        label =  config['z02']['label']
        min_distance = config['z02']['min_distance']
        fcs_umap_savefile = config['z02']['fcs_umap_savefile']
