...
## in house
# sys.path.insert(0, '/project/iprime_storage/myles_kim/_Spect_Analysis/_B_cells_LLM3')
sys.path.insert(0, './')
...
if __name__ == "__main__":
    ...
    with open('config.yaml', 'r') as f:
        ...
        inputfiles = config['all']['outputdir']
        ...
        figure_dir = outputdir+'/'+config['z00']['figure_dir'] # figure_dir: where to save figures
        savefile_fcs_trimmed = outputdir+'/'+config['z00']['savefile_fcs_trimmed']
